                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Silahkan ditambahkan Data Penjualan</h6>
                        </div>
                        <div class="card-body">
                        <form action="<?php echo site_url('penjualan/aksi_tambahpenjualan'); ?>" method="POST">
                        <div class="mb-3">
                                <label for="tglPengambilan" class="form-label">Tanggal Pengambilan</label>
                                <input type="date" name="Tgl_Pengambilan" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label for="totalByr" class="form-label">Total Bayar</label>
                                <input type="text" name="Total_Byr" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label for="Tgl_JatuhTempo" class="form-label">Tanggal Jatuh Tempo</label>
                                <input type="date" name="Tgl_JthTempo" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label for="Pembayaran_Cicilan" class="form-label">Pembayaran Cicilan</label>
                                <input type="text" name="Pembayaran_Cicilan" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label for="Down_Payment" class="form-label">Down Payment</label>
                                <input type="text" name="Down_Payment" class="form-control" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Id_rumah" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label for="id_Cus" class="form-label">ID Customer</label>
                                <input type="text" name="Id_Cus" class="form-control" required>
                            </div>
